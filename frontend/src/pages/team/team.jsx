...
const Team = () => {
    ...
    return (
        <>
            <Navbar/>
            <div ref={teamRef} className="container mx-auto px-4 py-12">
                <h2 className="text-4xl font-bold text-center mb-8">Our Team</h2>
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8 teamCard">
                    {teamMembers.map((member, index) => (
                        <div
                            key={index}
                            className="team-card bg-white rounded-lg shadow-lg p-6 text-center transform transition-all duration-300 hover:z-10"
                        >
                            <img
                                src={member.image}
                                alt={member.name}
