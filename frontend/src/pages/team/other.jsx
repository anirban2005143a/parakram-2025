        ...
        <div className=" min-h-screen text-white z-10 relative">
            <div className="space-y-8">
                {others.map((team, index) => (
                    <div key={index} className=" p-6 rounded-xl border-[1px] border-gray-600 bg-[#100f0f59] backdrop-blur-xs ">
                        {/* Team Name and Role */}
                        ...
                        {/* Head Section */}
                        <div className="mt-6">
                            <h3 className="text-3xl underline underline-offset-8 font-semibold text-white text-center ">Head</h3>
                            <div className="px-5 w-full flex flex-wrap justify-center items-end">
                                {Array.isArray(team.Head) ? (
                                    team.Head.map((head, idx) => (
                                        <CardContainer key={idx} className="inter-var h-[460px] w-[380px] mx-2">
                                    ...
                                    <CardContainer key={team.Head.AdmissionNo} className="inter-var h-[460px] w-[380px] mx-2">
                                        <CardBody className="h-full relative group/card hover:shadow-2xl hover:shadow-emerald-500/[0.1] bg-[#0000005c] border-white/[0.2]  w-full  rounded-xl p-6 border">
                                            <CardItem
                                                translateZ="50"
                                                className="text-3xl font-bold text-white"
                        ...
                        {team.JointHeads && (
                            <div className="mt-6">
                                ...
                                <div className="px-5 flex w-full  flex-wrap justify-center items-center">
