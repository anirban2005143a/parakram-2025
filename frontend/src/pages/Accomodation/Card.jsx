...
function Card({ i, data }) {
  return (
    <div className="card cursor-pointer">
      <div className="content">
        <div className="back">
          <div className="back-content cursor-pointer">
            <svg
              stroke="#ffffff"
            ...
            <strong className="text-4xl sm:text-3xl md:text-2xl">Option {i}</strong>
          </div>
        </div>
        <div className="front">
          <div className="img">
          ...
          <div className="front-content">
            <div className="description">
              <div className="title">
                <p className="title">
                  <strong className="text-3xl sm:text-1xl md:text-2xl">{data}</strong>
                </p>
              </div>
            </div>
          </div>
