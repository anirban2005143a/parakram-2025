...
//   return (
//     <div className='w-full h-full overflow-visible cursor-grab active:cursor-grabbing' ref={containerRef} />
//   )
// }
...
class App {
  ...
  createCamera() {
    ...
    this.camera.fov = 45;
    this.camera.position.z = 20;
    // this.camera.position.x = -(window.innerWidth / 2); // Shift camera to center the gallery
  }
  createScene() {
    this.scene = new Transform();
  }
  ...
  onResize() {
    this.screen = {
      width: 1200, // Fixed width for the gallery
      height: this.container.clientHeight
    };
    this.renderer.setSize(this.screen.width, this.screen.height);
    this.camera.perspective({
