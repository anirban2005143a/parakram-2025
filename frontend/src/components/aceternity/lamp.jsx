    ...
    (<div
      ...
      <div
        ...
        <motion.div
          ...
          className="absolute inset-auto right-1/2 h-56 overflow-visible w-[30rem] bg-gradient-conic from-[#008c99] via-transparent to-transparent text-white [--conic-position:from_70deg_at_center_top]">
          <div
        ...
        <motion.div
          ...
          className="absolute inset-auto left-1/2 h-56 w-[30rem] bg-gradient-conic from-transparent via-transparent to-[#00656e] text-white [--conic-position:from_290deg_at_center_top]">
          <div
        ...
        <div
          className="absolute inset-auto z-50 h-36 w-[28rem] -translate-y-1/2 rounded-full bg-[#00656e] opacity-50 blur-3xl"></div>
        <motion.div
          initial={{ width: "8rem" }}
          ...
          className="absolute inset-auto z-30 h-36 w-64 -translate-y-[6rem] rounded-full bg-[#038c99] blur-2xl"></motion.div>
        <motion.div
          initial={{ width: "15rem" }}
