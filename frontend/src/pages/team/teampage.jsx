import {
  ...
  function Teampage() {
    ...
    const Leadershipdata = Array(10).fill({
      image: "https://res.cloudinary.com/dfczrbv7b/image/upload/v1736708702/tndurhwxcbbttytnmlnr.png",
      name: "Prof. Vinay Kumar Rajak",
      Role: "Convenor",
      Dept: "Dept. of Petroleum Engineering",
    });
  
    const CoreTeam = Array(10).fill({
      image: "https://res.cloudinary.com/dfczrbv7b/image/upload/v1736708702/tndurhwxcbbttytnmlnr.png",
      name: "Prof. Vinay Kumar Rajak",
      Role: "Convenor",
      Dept: "Dept. of Petroleum Engineering",
    ...
    const Developers = Array(10).fill({
      image: "https://res.cloudinary.com/dfczrbv7b/image/upload/v1736708702/tndurhwxcbbttytnmlnr.png",
      name: "Prof. Vinay Kumar Rajak",
      Role: "Convenor",
      Dept: "Dept. of Petroleum Engineering",
